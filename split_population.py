...
arcpy.env.workspace = "F:\_data\google_drive\Biking Public Project\maps"
arcpy.env.overwriteOutput = True

census_blocks = "F:\_data\google_drive\Biking Public Project\maps/nyc_census_blocks_copy.shp"
precincts = "F:\_data\google_drive\Biking Public Project\maps\NYC_precincts_utm18_copy.shp"
census_lyr = "census_lyr"
precincts_lyr = "precincts_lyr"
c_diss_lyr = "cen_diss_lyr.shp"
...
ccursor = arcpy.da.SearchCursor(census_lyr, ["precinct", "POP10"])
...
print "dissolving..."
arcpy.Dissolve_management(sel_cb, c_diss_lyr, dissolve_field="precinct", statistics_fields=[["POP10", 'SUM']]) #
